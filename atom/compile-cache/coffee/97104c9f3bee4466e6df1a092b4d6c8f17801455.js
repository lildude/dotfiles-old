  ...
  module.exports = CanvasDrawer = (function(_super) {
    ...
    CanvasDrawer.prototype.getInvisibleRegExp = function(line) {
      if ((line != null) && (line.invisibles != null)) {
        return RegExp("" + (_.escapeRegExp(line.invisibles.cr)) + "|" + (_.escapeRegExp(line.invisibles.eol)) + "|" + (_.escapeRegExp(line.invisibles.space)) + "|" + (_.escapeRegExp(line.invisibles.tab)), "g");
      }
    };
