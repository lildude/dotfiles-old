(function() {
  ...
  Linter = (function() {
    ...
    function Linter(editor) {
      ...
      deprecate('AtomLinter v0.X.Y API has been deprecated. Please refer to the Linter docs to update and the latest API: https://github.com/atom-community/linter/wiki/Migrating-to-the-new-API');
