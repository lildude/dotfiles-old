(function() {
  ...
  module.exports = InsertLinkView = (function(_super) {
      ...
      if (title) {
        ...
        this.editor.buffer.scan(referenceTagRegex, (function(_this) {
          return function(match) {
            return _this.editor.setTextInBufferRange(match.range, _this._referenceLink(url, title));
          };
        })(this));
    ...
    InsertLinkView.prototype.insertReferenceLink = function(text, title, url) {
      ...
      referenceText = "[" + text + "][" + this.referenceId + "]";
      this.editor.setTextInBufferRange(this.range, referenceText);
      referenceLink = this._referenceLink(url, title);
      if (config.get("referenceInsertPosition") === "article") {
        return helper.insertAtEndOfArticle(this.editor, referenceLink);
      } else {
        return helper.insertAfterCurrentParagraph(this.editor, referenceLink);
      }
    };
    ...
    InsertLinkView.prototype._referenceLink = function(url, title) {
      var indent;
    ...
    InsertLinkView.prototype.loadSavedLinks = function(callback) {
      ...
      readFile = function(file) {
        return CSON.readFile(file, function(err, data) {
    ...
    InsertLinkView.prototype.fetchPosts = function() {
      ...
      if (posts) {
        return (!(posts.length > 0) ? this.searchBox.hide() : void 0);
      }
