(function() {
  ...
  module.exports = InsertLinkView = (function(_super) {
    ...
    InsertLinkView.prototype.definitionRange = null;
    ...
    InsertLinkView.prototype.updateReferenceLink = function(text, title, url) {
      var definition, link;
      if (title) {
        link = "[" + text + "][" + this.referenceId + "]";
        this.editor.setTextInBufferRange(this.range, link);
        definition = this._referenceDefinition(url, title);
        return this.editor.setTextInBufferRange(this.definitionRange, definition);
      } else {
    ...
    InsertLinkView.prototype.insertReferenceLink = function(text, title, url) {
      ...
      if (config.get("referenceInsertPosition") === "article") {
        return helper.insertAtEndOfArticle(this.editor, definition);
      } else {
        return helper.insertAfterCurrentParagraph(this.editor, definition);
      }
    };
